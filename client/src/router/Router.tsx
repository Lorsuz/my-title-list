...
const Sign = lazy(() => import('@page/FormSign'));
...
const Router: React.FunctionComponent = () => (
	<Routes>
		...
		<Route path={AppRoutes.login} element={<LazyComponent element={Login} />} />
		<Route path={AppRoutes.sign} element={<LazyComponent element={Sign} />} />
