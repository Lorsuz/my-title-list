...
export declare type GetFindResult<P extends OperationPayload, A> =
	Equals<A, any> extends 1
		...
		: A extends
			...
			? {
					[K in keyof S | keyof I as (S & I)[K] extends false | undefined | null ? never : K]: (S & I)[K] extends object
...
declare namespace Types {
	export { Result_3 as Result, Extensions_2 as Extensions, Utils, Public_2 as Public, OperationPayload as Payload };
}
export { Types };
