	...
	ge = class {
		constructor(n) {
			n === ne
				...
				: pe.set(this, 'new Prisma.'.concat(this._getNamespace(), '.').concat(this._getName(), '()'));
		}
		_getName() {
...
var H = 9e15,
	...
	Ne = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -H, maxE: H, crypto: !1 },
	qe,
	Z,
	w = !0,
	oe = '[DecimalError] ',
...
d.inverseTangent = d.atan = function () {
	...
	for (w = !1, n = Math.ceil(u / m), r = 1, l = f.times(f), o = new c(f), t = f; e !== -1; )
		if (
			((t = t.times(l)),
			(s = o.minus(t.div((r += 2)))),
			(t = t.times(l)),
...
d.logarithm = d.log = function (e) {
	...
	if (
		((w = !1), (u = a + g), (o = B(f, u)), (r = n ? se(c, u + 10) : B(e, u)), (l = S(o, r, u, 1)), Q(l.d, (t = a), h))
	)
		do
...
d.minus = d.sub = function (e) {
	...
	if (((i = A(e.e / m)), (c = A(g.e / m)), (f = f.slice()), (s = c - i), s)) {
		for (
			a = s < 0,
				a ? ((n = f), (s = -s), (o = h.length)) : ((n = h), (i = c), (o = f.length)),
	...
	return (
		...
		!i.d || !e.s || (e.d && !e.d[0])
			...
			: !e.d || (i.d && !i.d[0])
				...
				: ((w = !1),
					r.modulo == 9 ? ((n = S(i, e.abs(), 0, 3, 1)), (n.s *= e.s)) : (n = S(i, e, 0, r.modulo, 1)),
					(n = n.times(e)),
					(w = !0),
					i.minus(n))
	);
...
d.plus = d.add = function (e) {
	...
	if (((s = A(a.e / m)), (r = A(e.e / m)), (f = f.slice()), (t = s - r), t)) {
		for (
			t < 0 ? ((i = f), (t = -t), (o = c.length)) : ((i = c), (r = s), (o = f.length)),
				s = Math.ceil(u / m),
				o = s > o ? s + 1 : o + 1,
				t > o && ((t = o), (i.length = 1)),
				i.reverse();
		...
		w = !1,
			...
			f == 0 || f == 1 / 0
				? ((n = O(u)),
					...
					(f = Math.sqrt(n)),
					(l = A((l + 1) / 2) - (l < 0 || l % 2)),
					f == 1 / 0 ? (n = '5e' + l) : ((n = f.toExponential()), (n = n.slice(0, n.indexOf('e') + 1) + l)),
					(r = new c(n)))
				: (r = new c(f.toString())),
			i = (l = c.precision) + 3;
		;
...
d.toDecimalPlaces = d.toDP = function (e, n) {
	var i = this,
		r = i.constructor;
	return (
		(i = new r(i)), e === void 0 ? i : (q(e, 0, V), n === void 0 ? (n = r.rounding) : q(n, 0, 8), p(i, e + i.e + 1, n))
	);
};
d.toExponential = function (e, n) {
	...
	return (
		e === void 0
			? (i = I(r, !0))
			: (q(e, 0, V), n === void 0 ? (n = t.rounding) : q(n, 0, 8), (r = p(new t(r), e + 1, n)), (i = I(r, !0, e + 1))),
...
d.toPower = d.pow = function (e) {
	...
	return (
		(i = M(+u, f)),
		(n = i == 0 || !isFinite(i) ? A(f * (Math.log('0.' + O(u.d)) / Math.LN10 + u.e + 1)) : new l(i + '').e),
...
d.toSignificantDigits = d.toSD = function (e, n) {
	var i = this,
		r = i.constructor;
	return (
		e === void 0 ? ((e = r.precision), (n = r.rounding)) : (q(e, 1, V), n === void 0 ? (n = r.rounding) : q(n, 0, 8)),
		p(new r(i), e, n)
	);
};
d.toString = function () {
	...
	return (
		...
		r == null
			? n < 3
				...
				: (o =
						(((i < 4 && u + 1 == s) || (i > 3 && u + 1 == s / 2)) && ((e[t + 1] / s / 100) | 0) == M(10, n - 2) - 1) ||
...
var S = (function () {
	...
	return function (r, t, s, o, u, l) {
		...
		if (
			(k[a] > (b[a] || 0) && c--,
			s == null ? ((D = s = ee.precision), (o = ee.rounding)) : u ? (D = s + (r.e - t.e) + 1) : (D = s),
			D < 0)
		)
			T.push(1), (v = !0);
		else {
			if (((D = (D / g + 2) | 0), (a = 0), L == 1)) {
				...
				for (
					h = (l / (k[0] + 1)) | 0,
						h > 1 && ((k = e(k, h, l)), (b = e(b, h, l)), (L = k.length), (W = b.length)),
						z = L,
						E = b.slice(0, L),
						P = E.length;
					P < L;
					...
					(h = 0),
						...
						f < 0
							? ((x = E[0]),
								...
								_ < P && N.unshift(0),
								i(E, N, P, l),
								f == -1 && ((P = E.length), (f = n(k, E, L, P)), f < 1 && (h++, i(E, L < P ? y : k, P, l))),
								(P = E.length))
							: f === 0 && (h++, (E = [0])),
						(T[a++] = h),
...
function p(e, n, i, r) {
	...
	e: if (n != null) {
		...
		if (
			((r = r || n < 0 || a[h + 1] !== void 0 || (o < 0 ? c : c % M(10, t - o - 1))),
			(f =
				i < 4
					? (l || r) && (i == 0 || i == (e.s < 0 ? 3 : 2))
					: l > 5 ||
						(l == 5 &&
							(i == 4 ||
								r ||
								(i == 6 && (s > 0 ? (o > 0 ? c / M(10, t - o) : 0) : a[h - 1]) % 10 & 1) ||
								i == (e.s < 0 ? 8 : 7)))),
			n < 1 || !a[0])
		)
			return (
				(a.length = 0), f ? ((n -= e.e + 1), (a[0] = M(10, (m - (n % m)) % m)), (e.e = -n || 0)) : (a[0] = e.e = 0), e
			);
		if (
			(s == 0
				? ((a.length = h), (u = 1), h--)
				: ((a.length = h + 1), (u = M(10, m - s)), (a[h] = o > 0 ? ((c / M(10, t - o)) % M(10, o) | 0) * u : 0)),
			f)
		)
			for (;;)
				if (h == 0) {
...
function Ee(e, n) {
	...
	for (n == null ? ((w = !1), (l = v)) : (l = n), u = new h(0.03125); e.e > -2; ) (e = e.times(u)), (a += 5);
	for (r = ((Math.log(M(2, a)) / Math.LN10) * 2 + 5) | 0, l += r, i = s = o = new h(1), h.precision = l; ; ) {
		if (
			...
			if (n == null)
				if (f < 3 && Q(o.d, l - r, g, f)) (h.precision = l += 10), (i = s = u = new h(1)), (c = 0), f++;
...
function nn(e, n) {
	...
	for (
		s = n.search(/p/i),
			...
			o = s >= 0,
			r = e.constructor,
			o && ((n = n.replace('.', '')), (u = n.length), (s = u - s), (t = De(r, new r(i), s, s * 2))),
			f = ie(n, i, F),
			c = f.length - 1,
			s = c;
		f[s] === 0;
...
function ke(e, n, i, r) {
	var t,
		...
		v = i !== void 0;
	if (
		(v ? (q(i, 1, V), r === void 0 ? (r = g.rounding) : q(r, 0, 8)) : ((i = g.precision), (r = g.rounding)),
		!e.isFinite())
	)
		c = Ue(e);
	else {
		for (
			c = I(e),
				o = c.indexOf('.'),
				v ? ((t = 2), n == 16 ? (i = i * 4 - 3) : n == 8 && (i = i * 3 - 2)) : (t = n),
				o >= 0 &&
					((c = c.replace('.', '')), (h = new g(1)), (h.e = c.length - o), (h.d = ie(I(h), 10, t)), (h.e = h.d.length)),
				a = ie(c, 10, t),
				s = l = a.length;
			a[--l] == 0;
		...
		if (!a[0]) c = v ? '0p+0' : '0';
			...
			if (
				(o < 0
					? s--
					: ((e = new g(e)), (e.d = a), (e.e = s), (e = S(e, h, i, r, 0, t)), (a = e.d), (s = e.e), (f = qe)),
				(o = a[i]),
				(u = t / 2),
				(f = f || a[i + 1] !== void 0),
				(f =
					r < 4
						...
						: o > u || (o === u && (r === 4 || f || (r === 6 && a[i - 1] & 1) || r === (e.s < 0 ? 8 : 7)))),
				(a.length = i),
				f)
			)
...
function $e(e) {
	...
	function t(s) {
		...
		return (
			(u = s.charCodeAt(0)) === 45 ? ((s = s.slice(1)), (f.s = -1)) : (u === 43 && (s = s.slice(1)), (f.s = 1)),
	...
	if (
		...
		for (
			r = ['precision', 'rounding', 'toExpNeg', 'toExpPos', 'maxE', 'minE', 'modulo', 'crypto'], n = 0;
			n < r.length;
	...
	if ((e === void 0 ? (e = this.precision) : q(e, 1, V), (r = Math.ceil(e / m)), this.crypto))
		if (crypto.getRandomValues)
			...
			for (n = crypto.randomBytes((r *= 4)); s < r; )
				(t = n[s] + (n[s + 1] << 8) + (n[s + 2] << 16) + ((n[s + 3] & 127) << 24)),
					t >= 214e7 ? crypto.randomBytes(4).copy(n, s) : (u.push(t % 1e7), (s += 4));
			s = r / 4;
		} else throw Error(Le);
